...
(function () {
    var a = function (a) {
        return[
            {type: "lang", regex: "\\B(\\\\)?@([\\S]+)\\b", replace: function (a, b, c) {
...
(function () {
    var a = function (a) {
        ...
        return b.th = function (a) {
            ...
            var a = "", c = 0, d = [].slice.apply(arguments);
            ...
            for (c; c < d.length; c += 1) {
                f = d[c];
                if (f.trim().match(/^[|]{1}.*[|]{1}$/)) {
                    f = f.trim(), e.push("<table class=\"table table-striped table-bordered table-hover\">"), g = f.substring(1, f.length - 1).split("|"), e.push(b.thead.apply(this, g)), f = d[++c];
                    if (!!f.trim().match(/^[|]{1}[-=| ]+[|]{1}$/)) {
                        f = d[++c], e.push("<tbody>");
...
(function () {
    var a = function (a) {
        return[
            {type: "lang", regex: "(~T){2}([^~]+)(~T){2}", replace: function (a, b, c, d) {
                return"<del>" + c + "</del>"
            }}
        ]
    };
